...
* [2 Menus](broken-reference)
  * [2.1 Warps](broken-reference)
    * [2.1.1 Locations](broken-reference)
    * [2.1.2 Bosses](broken-reference)
  * [2.2 Cheats](broken-reference)
  * [2.3 Player](broken-reference)
    * [2.3.1 Stats](broken-reference)
    * [2.3.2 Gear](broken-reference)
    * [2.3.3 Partners](broken-reference)
    * [2.3.4 Badges](broken-reference)
    * [2.3.5 Items](broken-reference)
    * [2.3.6 Star Spirits](broken-reference)
    * [2.3.7 Misc](broken-reference)
  * [2.4 File](broken-reference)
  * [2.5 Practice](broken-reference)
    * [2.5.1 Trainers](broken-reference)
    * [2.5.2 Timer](broken-reference)
  * [2.6 Camera](broken-reference)
  * [2.7 Watches](broken-reference)
  * [2.8 Debug](broken-reference)
  * [2.9 Settings](broken-reference)
* [3 Known Issues](broken-reference)

## 1 Introduction

The main interface for interacting with fp is the utility menu, which can be accessed by pressing `R + D-Up`. This menu can be navigated with the D-pad, and L is used to make a selection. To quickly go back a menu, press `R + D-Left`. To close the menu, press `R + D-Up` again. These button combos can also be configured (see [2.9 Settings](broken-reference)).
...
Both the **trainers** and **timer** menu have a `save settings` button. This button has the same function as the one in settings (see [2.9 Settings](broken-reference)) which is saving all fp settings to the current profile.
...
Note that button combinations can be configured for the `start/stop` and `reset` functions, and the position of the timer can be configured in settings (see [2.9 Settings](broken-reference)).
